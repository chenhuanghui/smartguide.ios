...
{
    [self registerNib:[UINib nibWithNibName:@"SUKMNewsCell" bundle:nil] forCellReuseIdentifier:@"SUKMNewsCell"];
}

-(SUKMNewsCell *)SUKMNewsCell
{
    return [self dequeueReusableCellWithIdentifier:@"SUKMNewsCell"];
}
