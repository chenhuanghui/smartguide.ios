...
@interface SGQRCodeResultViewController ()

@end

@implementation SGQRCodeResultViewController

- (SGQRCodeResultViewController *)initWithResult:(id)result
{
    self = [super initWithNibName:@"SGQRCodeResultViewController" bundle:nil];
    if (self) {
