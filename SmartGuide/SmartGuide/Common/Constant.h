...
#define API_ELASTIC_AUTOCOMPLETE_NATIVE [NSString stringWithFormat:@"%@://116.251.210.100:9200/data/_search",SERVER_IP]
...
#define API_USER_NOTIFICATION_DETAIL @"user/notificationContent"
