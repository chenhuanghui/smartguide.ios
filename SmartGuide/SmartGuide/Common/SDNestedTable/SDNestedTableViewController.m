...
- (void) mainItemDidChange: (SDGroupCell *)item forTap:(BOOL)tapped
{
    ...
    {
        [delegate performSelector:@selector(mainTable:itemDidChange:) withObject:self.table withObject:item];
    }
}
...
{
    NSIndexPath *groupCellIndexPath = [self.table indexPathForCell:cell];
